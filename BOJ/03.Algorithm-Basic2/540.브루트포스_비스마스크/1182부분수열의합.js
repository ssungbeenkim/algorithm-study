...
/*  
- 보다 직접적으로 비트마스킹을 적용한 풀이도 한번 분석해보고 비트마스킹에 대해 스킬을 습득하고 넘어가면 될 것 같다.
- 비트마스크에 대한 학습이 필요할 것 같아서 비트 연산에 대해 먼저 정리하고, 어떻게 적용해서 풀 수 있을지  
비트 연산에 대해 먼저 학습하고, 적용해서 다시 풀어보도록 한다. 
*/
{
  const [n, s, ...arr] = `5 0
-7 -3 -2 5 8`
...
// 비트마스크가 참 효율적으로 문제를 처리할 수 있는 방법이겠구나
// 특히 주어진 리스트에서 모든 경우를 확인하는 경우 조합을 생성하는 로직 없이도
// 간단하게 확인할 수 있겠구나 라는 생각을 하게 되었다! Q.E.D
